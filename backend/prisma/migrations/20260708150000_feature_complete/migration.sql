...
UPDATE "bookings" SET "booking_number" = 'BKG-' || SUBSTRING("id"::text, 1, 8) WHERE "booking_number" IS NULL;
...
CREATE UNIQUE INDEX IF NOT EXISTS "reviews_user_id_product_id_order_id_key" ON "reviews"("user_id", "product_id", "order_id");
CREATE UNIQUE INDEX IF NOT EXISTS "reviews_user_id_provider_id_booking_id_key" ON "reviews"("user_id", "provider_id", "booking_id");
